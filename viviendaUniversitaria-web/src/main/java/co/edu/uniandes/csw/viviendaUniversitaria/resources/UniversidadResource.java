...
public class UniversidadResource {
    ...
    @POST
    public UniversidadDetailDTO createUbicacion(UniversidadDetailDTO ubi) throws BusinessLogicException{
    ...
    @PUT
    @Path("id: \\+d")
    public UniversidadDetailDTO updateUbicacion(@PathParam("id") Long id,UniversidadDetailDTO ubi) throws BusinessLogicException{
