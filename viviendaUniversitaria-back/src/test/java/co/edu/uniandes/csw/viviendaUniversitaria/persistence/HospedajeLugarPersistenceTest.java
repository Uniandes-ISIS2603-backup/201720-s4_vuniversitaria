...
public class HospedajeLugarPersistenceTest {
    ...
    @Inject
    private LugaresInteresPersistence persistenceLugar;
    @Inject
    private HospedajePersistence persistenceHospedaje;
    /**
    ...
    public void testCreate() throws Exception {
        ...
        LugaresInteresEntity lugar = persistenceLugar.create(factory.manufacturePojo(LugaresInteresEntity.class));
        HospedajeEntity hospedaje = persistenceHospedaje.create(factory.manufacturePojo(HospedajeEntity.class));
        newEntity.setHospedaje(hospedaje);
        newEntity.setLugarInteres(lugar);
